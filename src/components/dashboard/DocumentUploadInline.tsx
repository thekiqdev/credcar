/**
 * Componente de Upload de Documentos - Inline
 * Versão inline do DocumentUploadModal para uso direto na página
 */
...
const DocumentUploadInline: React.FC<DocumentUploadInlineProps> = ({
  representativeId,
  representativeName,
  ...
  useEffect(() => {
    console.log('🔄 DocumentUploadInline: Carregando status dos documentos...');
    loadDocumentStatus();
  }, [representativeId]);

  const loadDocumentStatus = async () => {
    try {
      console.log('📋 DocumentUploadInline: loadDocumentStatus chamado');
      setIsLoading(true);
...
export default DocumentUploadInline;
