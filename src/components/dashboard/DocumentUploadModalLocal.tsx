...
const DocumentUploadModalLocal: React.FC<DocumentUploadModalProps> = ({
  ...
  const [documents, setDocuments] = useState<DocumentFile[]>([
    { id: '1', type: 'RG/CPF', file: null, status: 'pending', progress: 0 },
    { id: '2', type: 'Comprovante de Residência', file: null, status: 'pending', progress: 0 },
    { id: '3', type: 'Comprovante de Renda', file: null, status: 'pending', progress: 0 },
    { id: '4', type: 'Comprovante Bancário', file: null, status: 'pending', progress: 0 }
  ]);
